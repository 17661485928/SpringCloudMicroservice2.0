package com.qht.springbootproducer.conf;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.qht.springbootproducer.api.*.*(..))")
    ...
    @AfterReturning(returning = "responseMsg", pointcut = "webApiLog()")
