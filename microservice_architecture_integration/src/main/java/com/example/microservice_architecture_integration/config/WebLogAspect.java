...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.example.microservice_architecture_integration.controller.*.*(..))")
    public void mongoDBControllerLog() {
    }

    @Before("mongoDBControllerLog()")
    ...
    @AfterReturning(returning = "responseMsg", pointcut = "mongoDBControllerLog()")
